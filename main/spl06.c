...
#define I2C_MASTER_FREQ_HZ 8000

#define I2C_SPL_MASTER_SDA_IO 8
#define I2C_SPL_MASTER_SCL_IO 9
...
spl06_t *spl06_init(esp_event_loop_handle_t event_loop_hdl) {
    ...
    i2c_config_t conf = {
            ...
            .sda_io_num = I2C_SPL_MASTER_SDA_IO,         // select GPIO specific to your project
            .sda_pullup_en = GPIO_PULLUP_ENABLE,
            .scl_io_num = I2C_SPL_MASTER_SCL_IO,         // select GPIO specific to your project
    ...
    ESP_LOGI(TAG, "spl06 start for init scl:%d sda:%d", I2C_SPL_MASTER_SCL_IO, I2C_SPL_MASTER_SDA_IO);

    ESP_ERROR_CHECK(i2c_driver_install(I2C_MASTER_NUM, conf.mode, 0, 0, 0));
    ESP_LOGI(TAG, "spl06 I2C initialized successfully sda: %d, scl:%d", I2C_SPL_MASTER_SDA_IO, I2C_SPL_MASTER_SCL_IO);
...
//                ESP_LOGI(TAG, "spl06 raw_temp %d,  temp: %f", spl06->raw_temp, temp);
            ...
            if (data_updated) {
                if (spl06->event_loop_hdl) {
                    esp_event_post_to(spl06->event_loop_hdl, BIKE_PRESSURE_SENSOR_EVENT, SPL06_SENSOR_UPDATE,
                                      &(spl06->data), sizeof(pressure_sensor_data_t), 100 / portTICK_PERIOD_MS);
                } else {
                    esp_event_post(BIKE_PRESSURE_SENSOR_EVENT, SPL06_SENSOR_UPDATE,
                                      &(spl06->data), sizeof(pressure_sensor_data_t), 100 / portTICK_PERIOD_MS);
                }
            }
        }
